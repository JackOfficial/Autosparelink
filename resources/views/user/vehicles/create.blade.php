...
@section('content')
{{-- Added photoPreview and fileSelected to x-data --}}
                ...
                <div class="card-header bg-white border-0 pt-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">Enter your vehicle details for tailored services and alerts.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('vehicles.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <div class="upload-container border-dashed rounded-4 p-4 text-center bg-light position-relative" 
                                         :class="photoPreview ? 'p-2' : 'p-5'">
                                        
                                        <input type="file" name="vehicle_photo" id="vehicle_photo" 
                                               class="d-none" accept="image/*" @change="previewImage">
                                        
                                        <label for="vehicle_photo" class="mb-0 cursor-pointer d-block">
                                            <template x-if="!photoPreview">
                                                <div>
                                                    <i class="fas fa-camera fa-3x text-primary mb-3 opacity-50"></i>
                                                    <h6 class="fw-bold text-dark">Upload Car Photo</h6>
                                                    <p class="text-muted small mb-0">Click to browse your gallery (Max 2MB)</p>
                                                </div>
                                            </template>
                                            
                                            <template x-if="photoPreview">
                                                <div class="position-relative">
                                                    <img :src="photoPreview" class="rounded-4 img-fluid shadow-sm" style="max-height: 250px; width: 100%; object-fit: cover;">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-text x-small">Type to search or add your own.</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="displacement" id="displacement" class="form-control border-0 bg-light rounded-3 py-2" placeholder="e.g. 2.0L or 2000cc">
                                </div>
                        ...
                        <div class="bg-light rounded-4 p-4 mb-4 border border-opacity-10">
                            <div class="row align-items-center g-3">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="vin" id="vin" class="form-control border-white shadow-sm rounded-3 py-2" maxlength="17" placeholder="17-character VIN">
                                    <div class="form-text x-small">Optional: Used for exact spare part matching.</div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-check form-switch p-3 bg-white rounded-3 shadow-sm d-flex align-items-center justify-content-between">
                                        ...
                                        <input class="form-check-input me-2" type="checkbox" name="is_primary" id="is_primary" value="1" checked>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5 py-2 fw-bold shadow">
                                Save Vehicle <i class="fas fa-check-circle ms-2"></i>
                            </button>
                        </div>
                    </form>
                </div>
...
<style>
    ...
    .x-small { font-size: 0.75rem; color: #adb5bd; }
</style>
@endsection