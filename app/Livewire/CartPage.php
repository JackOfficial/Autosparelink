...
class CartPage extends Component
{
    ...
    // Public properties to bind dynamically to your Blade template layout frame
    ...
    public function render()
    {
        ...
        // Target contextual location to offer instant, proportional cost visibility
        ...
        return view('livewire.cart-page', [
            ...
            'total'             => $this->totalWithShipping, // Keeps both keys safe depending on your view choice
        ]);
    }
}