...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('specifications', function (Blueprint $table) {
                $table->dropForeign(['variant_id']);  // Drop foreign key first

    $table->unsignedBigInteger('variant_id')->nullable()->change(); // Modify column to nullable

    $table->foreign('variant_id')->references('id')->on('variants')->cascadeOnDelete(); // Recreate foreign key
