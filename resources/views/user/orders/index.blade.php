            ...
            <form action="{{ route('user.orders.index') }}" method="GET" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="status" class="form-select rounded-3 border-light-subtle">
                        ...
                        @foreach(['pending', 'callback_requested', 'processing', 'delivered', 'completed', 'disputed', 'cancelled'] as $status)
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody class="border-top-0">
                    @forelse($orders as $order)
                        ...
                        // Exact unpaid check based on your status logic
                        $isUnpaid = in_array($order->status, ['pending', 'callback_requested']);
                        @endphp
                        <tr x-data="{ 
                            copied: false, 
                            copyId() { 
                           ...
                           <td class="py-3">
                            ...
                            <td class="py-3 text-center">
                                @php
                                    $statusConfig = [
                                        ...
                                        'callback_requested' => ['class' => 'bg-info-subtle text-info border-info-subtle', 'icon' => 'fa-phone'],
                                ...
                                @endphp
                                <span class="badge {{ $config['class'] }} border rounded-pill px-3 py-2 fw-medium" style="font-size: 0.7rem;">
                            ...
                            <td class="px-4 py-3 text-end">
                                <div class="d-flex align-items-center justify-content-end gap-2">
                                    ...
                                    @if($isUnpaid)
                                        <a href="{{ route('user.orders.pay', $order->id) }}" class="btn btn-success btn-sm rounded-3 shadow-sm px-3 fw-bold">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3">
                                            @if($isUnpaid)
                                                <li><a class="dropdown-item py-2 fw-bold text-success" href="{{ route('user.orders.pay', $order->id) }}"><i class="fas fa-credit-card me-2"></i> Pay Now</a></li>
