                        ...
                        <fieldset class="border p-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Optional">
                                </div>
                                <div class="col-md-4">
                                    <label for="model_code">Model Code</label>
                                    <input type="text" name="model_code" id="model_code" class="form-control" value="{{ old('model_code') }}">
                                </div>
                                <div class="col-md-4">
                                    <label for="chassis_code">Chassis Code</label>
                                    <input type="text" name="chassis_code" id="chassis_code" class="form-control" value="{{ old('chassis_code') }}">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="drive_type" id="drive_type" class="form-control">
                                        ...
                                        @foreach($driveTypes as $drive)
                                            <option value="{{ $drive->name }}" {{ old('drive_type') == $drive->name ? 'selected' : '' }}>
                                                {{ $drive->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="steering_position" id="steering_position" class="form-control">
                                        ...
                                        <option value="LEFT" {{ old('steering_position') == 'LEFT' ? 'selected' : '' }}>Left-Hand Drive</option>
                                        <option value="RIGHT" {{ old('steering_position') == 'RIGHT' ? 'selected' : '' }}>Right-Hand Drive</option>
                                    </select>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="border p-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="trim_level" id="trim_level" class="form-control" value="{{ old('trim_level') }}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="production_start" id="production_start" class="form-control" value="{{ old('production_start') }}">
                                </div>
                                <div class="col-md-3">
                                    <label for="production_end">Production End</label>
                                    <input type="text" name="production_end" id="production_end" class="form-control" value="{{ old('production_end') }}">
                                </div>
                            </div>
                        </fieldset>
