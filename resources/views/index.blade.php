...
<style>
    ...
    .brand-pill { 
        background: rgba(255,255,255,0.08); border-radius: 999px; padding:6px 10px; 
        display:flex; gap:8px; align-items:center; color: #fff; font-weight:600; font-size:0.9rem; 
    }
    ...
    .feature-icon { 
        ...
        justify-content:center; background: rgba(13,110,253,0.08); color: var(--primary); 
    }
                ...
                <div class="d-flex align-items-center justify-content-between hero-popular mt-2">
                    <div>
                        ...
                        @foreach($brands->take(4) as $brand)
                            <a href="{{ url('models/'.$brand->id) }}" class="text-white fw-bold me-2">{{ $brand->brand_name }}</a>
                        @endforeach
                    ...
                    <div class="cat-item d-flex align-items-center gap-3 p-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <small class="text-muted">
                                {{ number_format($brand->parts_count ?? 0) }} 
                                {{ Str::plural('Product', $brand->parts_count ?? 0) }}
                            </small>
                        </div>
                    </div>
                </a>
