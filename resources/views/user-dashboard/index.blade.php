...
<body class="bg-light">
    ...
    <div class="d-flex min-vh-100">
        ...
        <div class="flex-grow-1 d-flex flex-column min-w-0">
            ...
            <nav id="topbar" class="navbar bg-white border-bottom sticky-top px-3">
                <div class="d-flex align-items-center w-100">
                    ...
                    <div class="d-none d-md-block flex-grow-0" style="width: 300px;">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control bg-light border-0" placeholder="Search parts by SKU or name...">
                        </div>
                    </div>
                    ...
                    <ul class="list-unstyled d-flex align-items-center mb-0 ms-auto gap-3">
                                    ...
                                    @if($stats['pending_pickup'] > 0)
                                        <a href="#" class="dropdown-item p-3 border-bottom d-flex gap-3 text-wrap">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Kigali Hub awaiting your dispatch</small>
                                            </div>
                                        </a>
                                    @endif
                                </div>
                        ...
                        <li class="dropdown border-start ps-3">
                            <a href="#" class="d-flex align-items-center text-decoration-none" data-bs-toggle="dropdown">
                                <img src="{{ auth()->user()->avatar ?? 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->name).'&background=0D8ABC&color=fff' }}" alt="Avatar" class="avatar avatar-sm rounded-circle shadow-sm me-2" />
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle mb-0">
                                            <tbody>
                                                ...
                                                @empty
                                                <tr><td colspan="3" class="text-center py-5 text-muted">No recent sales data.</td></tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                                    </div>
