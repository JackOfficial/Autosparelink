    ...
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
            ...
            <div class="card shadow-sm p-3 sticky-top" style="top:90px">
                ...
                <!-- CATEGORY -->
                <h6 class="fw-bold mt-3 mb-2">Categories</h6>
                <select class="form-select mb-3"
                        wire:model="category">
                    <option value="">All Categories</option>
                    @foreach($categories as $cat)
                        <option value="{{ $cat->id }}">
                            {{ $cat->category_name }} ({{ $cat->spare_parts_count }})
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col-lg-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <h5 class="fw-bold mb-0">
                        {{ $parts->total() }} Parts Found
                    </h5>
                    <small class="text-muted">
                        Showing {{ $parts->firstItem() }} -
                        {{ $parts->lastItem() }}
                    </small>
                </div>
            ...
            <div wire:loading.flex
                 class="justify-content-center align-items-center my-5">
