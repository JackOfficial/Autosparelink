<div class="container-fluid px-xl-5 py-4" x-data="{ grid: true }">
    <style>
        ...
        /* Category Styling */
        .category-item { border-radius: 8px !important; margin-bottom: 2px; border: none !important; transition: all 0.2s; color: #444; }
        ...
        /* THE FIX: Force your existing component to fill the grid column */
        ...
        <div class="col-lg-9">
            ...
            <div class="card spec-banner text-white shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-7">
                            <span class="badge badge-primary mb-2 px-3 text-uppercase">Technical Specs</span>
            ...
            <div class="row" wire:loading.remove>
                @forelse($parts as $part)
                    {{-- Parent Grid determines the columns --}}
                    <div :class="grid ? 'col-md-6 col-xl-4 mb-4' : 'col-12 mb-3'">
                        {{-- Wrapper neutralizes the internal col-lg-3 of your component --}}
